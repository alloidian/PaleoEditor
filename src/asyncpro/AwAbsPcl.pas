...
uses
  Windows, LCLIntf, LCLType, SysUtils, AdExcept, AwTPcl, OoMisc, AwUser, AdPort;
...
function apCrc32OfFile(P : PProtocolData; FName : PChar; Len : Integer) : Integer;
...
function apOctalStr(L : Integer) : String;
function apOctalStr2Long(S : String) : Integer;
...
const
  ...
  begin
    ...
    with P^ do begin
      ...
      aProtSection := TCriticalSection.Create;
