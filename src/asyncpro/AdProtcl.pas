...
uses
  Windows, SysUtils, Classes, Controls, Graphics, Forms, OoMisc, AwUser, AwTPcl, AwAbsPcl,
  AwXmodem, AwYmodem, AwZmodem, AwKermit, AwAscii, AdExcept, AdPort;
...
//sg    procedure SetCtl3D(const NewCtl3D : Boolean);
...
{TApdProtocol}
  ...
  begin
    if Source is TApdCustomProtocol then begin
      ...
      PData^.aProtSection := TCriticalSection.Create;
      {$ENDIF}
