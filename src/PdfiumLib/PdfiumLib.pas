...
const
  ...
  ImportFuncs: array[0..133 {$IFDEF MSWINDOWS}+ 1{$ENDIF}] of TImportFuncRec = (
    (P: @@FPDF_InitLibrary;                   N: UC + 'FPDF_InitLibrary' + AT0;                   Quirk: False),
    (P: @@FPDF_DestroyLibrary;                N: UC + 'FPDF_DestroyLibrary' + AT0;                Quirk: False),
    (P: @@FPDF_SetSandBoxPolicy;              N: UC + 'FPDF_SetSandBoxPolicy' + AT8;              Quirk: False),
    (P: @@FPDF_LoadDocument;                  N: UC + 'FPDF_LoadDocument' + AT8;                  Quirk: False),
    (P: @@FPDF_LoadMemDocument;               N: UC + 'FPDF_LoadMemDocument' + AT12;              Quirk: False),
    (P: @@FPDF_LoadCustomDocument;            N: UC + 'FPDF_LoadCustomDocument' + AT8;            Quirk: False),
    (P: @@FPDF_GetFileVersion;                N: UC + 'FPDF_GetFileVersion' + AT8;                Quirk: False),
    (P: @@FPDF_GetLastError;                  N: UC + 'FPDF_GetLastError' + AT0;                  Quirk: False),
    (P: @@FPDF_GetDocPermissions;             N: UC + 'FPDF_GetDocPermissions' + AT4;             Quirk: False),
    (P: @@FPDF_GetSecurityHandlerRevision;    N: UC + 'FPDF_GetSecurityHandlerRevision' + AT4;    Quirk: False),
    (P: @@FPDF_GetPageCount;                  N: UC + 'FPDF_GetPageCount' + AT4;                  Quirk: False),
    (P: @@FPDF_LoadPage;                      N: UC + 'FPDF_LoadPage' + AT8;                      Quirk: False),
    (P: @@FPDF_GetPageWidth;                  N: UC + 'FPDF_GetPageWidth' + AT4;                  Quirk: False),
    (P: @@FPDF_GetPageHeight;                 N: UC + 'FPDF_GetPageHeight' + AT4;                 Quirk: False),
    (P: @@FPDF_GetPageSizeByIndex;            N: UC + 'FPDF_GetPageSizeByIndex' + AT16;           Quirk: False),
    {$IFDEF MSWINDOWS}
    (P: @@FPDF_RenderPage;                    N: UC + 'FPDF_RenderPage' + AT32;                   Quirk: False),
    {$ENDIF MSWINDOWS}
    (P: @@FPDF_RenderPageBitmap;              N: UC + 'FPDF_RenderPageBitmap' + AT32;             Quirk: False),
    (P: @@FPDF_ClosePage;                     N: UC + 'FPDF_ClosePage' + AT4;                     Quirk: False),
    (P: @@FPDF_CloseDocument;                 N: UC + 'FPDF_CloseDocument' + AT4;                 Quirk: False),
    (P: @@FPDF_DeviceToPage;                  N: UC + 'FPDF_DeviceToPage' + AT40;                 Quirk: False),
    (P: @@FPDF_PageToDevice;                  N: UC + 'FPDF_PageToDevice' + AT48;                 Quirk: False),
    (P: @@FPDFBitmap_Create;                  N: UC + 'FPDFBitmap_Create' + AT12;                 Quirk: False),
    (P: @@FPDFBitmap_CreateEx;                N: UC + 'FPDFBitmap_CreateEx' + AT20;               Quirk: False),
    (P: @@FPDFBitmap_FillRect;                N: UC + 'FPDFBitmap_FillRect' + AT24;               Quirk: False),
    (P: @@FPDFBitmap_GetBuffer;               N: UC + 'FPDFBitmap_GetBuffer' + AT4;               Quirk: False),
    (P: @@FPDFBitmap_GetWidth;                N: UC + 'FPDFBitmap_GetWidth' + AT4;                Quirk: False),
    (P: @@FPDFBitmap_GetHeight;               N: UC + 'FPDFBitmap_GetHeight' + AT4;               Quirk: False),
    (P: @@FPDFBitmap_GetStride;               N: UC + 'FPDFBitmap_GetStride' + AT4;               Quirk: False),
    (P: @@FPDFBitmap_Destroy;                 N: UC + 'FPDFBitmap_Destroy' + AT4;                 Quirk: False),
    (P: @@FPDF_VIEWERREF_GetPrintScaling;     N: UC + 'FPDF_VIEWERREF_GetPrintScaling' + AT4;     Quirk: False),
    (P: @@FPDF_VIEWERREF_GetNumCopies;        N: UC + 'FPDF_VIEWERREF_GetNumCopies' + AT4;        Quirk: False),
    (P: @@FPDF_VIEWERREF_GetPrintPageRange;   N: UC + 'FPDF_VIEWERREF_GetPrintPageRange' + AT4;   Quirk: False),
    (P: @@FPDF_VIEWERREF_GetDuplex;           N: UC + 'FPDF_VIEWERREF_GetDuplex' + AT4;           Quirk: False),
    (P: @@FPDF_CountNamedDests;               N: UC + 'FPDF_CountNamedDests' + AT4;               Quirk: False),
    (P: @@FPDF_GetNamedDestByName;            N: UC + 'FPDF_GetNamedDestByName' + AT8;            Quirk: False),
    (P: @@FPDF_GetNamedDest;                  N: UC + 'FPDF_GetNamedDest' + AT16;                 Quirk: False),
    (P: @@FPDF_CreateNewDocument;             N: UC + 'FPDF_CreateNewDocument' + AT0;             Quirk: False),
    (P: @@FPDFPage_New;                       N: UC + 'FPDFPage_New' + AT24;                      Quirk: False),
    (P: @@FPDFPage_Delete;                    N: UC + 'FPDFPage_Delete' + AT8;                    Quirk: False),
    (P: @@FPDFPage_GetRotation;               N: UC + 'FPDFPage_GetRotation' + AT4;               Quirk: False),
    (P: @@FPDFPage_SetRotation;               N: UC + 'FPDFPage_SetRotation' + AT8;               Quirk: False),
    (P: @@FPDFPage_InsertObject;              N: UC + 'FPDFPage_InsertObject' + AT8;              Quirk: False),
    (P: @@FPDFPage_CountObject;               N: UC + 'FPDFPage_CountObject' + AT4;               Quirk: False),
    (P: @@FPDFPage_GetObject;                 N: UC + 'FPDFPage_GetObject' + AT8;                 Quirk: False),
    (P: @@FPDFPage_HasTransparency;           N: UC + 'FPDFPage_HasTransparency' + AT4;           Quirk: False),
    (P: @@FPDFPage_GenerateContent;           N: UC + 'FPDFPage_GenerateContent' + AT4;           Quirk: False),
    (P: @@FPDFPageObj_HasTransparency;        N: UC + 'FPDFPageObj_HasTransparency' + AT4;        Quirk: False),
    (P: @@FPDFPageObj_Transform;              N: UC + 'FPDFPageObj_Transform' + AT52;             Quirk: False),
    (P: @@FPDFPage_TransformAnnots;           N: UC + 'FPDFPage_TransformAnnots' + AT52;          Quirk: False),
    (P: @@FPDFPageObj_NewImgeObj;             N: UC + 'FPDFPageObj_NewImgeObj' + AT4;             Quirk: False),
    (P: @@FPDFImageObj_LoadJpegFile;          N: UC + 'FPDFImageObj_LoadJpegFile' + AT16;         Quirk: False),
    (P: @@FPDFImageObj_SetMatrix;             N: UC + 'FPDFImageObj_SetMatrix' + AT52;            Quirk: False),
    (P: @@FPDFImageObj_SetBitmap;             N: UC + 'FPDFImageObj_SetBitmap' + AT16;            Quirk: False),
    (P: @@FPDF_ImportPages;                   N: UC + 'FPDF_ImportPages' + AT16;                  Quirk: False),
    (P: @@FPDF_CopyViewerPreferences;         N: UC + 'FPDF_CopyViewerPreferences' + AT8;         Quirk: False),
    (P: @@FPDF_SaveAsCopy;                    N: UC + 'FPDF_SaveAsCopy' + AT12;                   Quirk: False),
    (P: @@FPDF_SaveWithVersion;               N: UC + 'FPDF_SaveWithVersion' + AT16;              Quirk: False),
    (P: @@FPDFPage_Flatten;                   N: UC + 'FPDFPage_Flatten' + AT8;                   Quirk: False),
    (P: @@FPDFText_LoadPage;                  N: UC + 'FPDFText_LoadPage' + AT4;                  Quirk: False),
    (P: @@FPDFText_ClosePage;                 N: UC + 'FPDFText_ClosePage' + AT4;                 Quirk: False),
    (P: @@FPDFText_CountChars;                N: UC + 'FPDFText_CountChars' + AT4;                Quirk: False),
    (P: @@FPDFText_GetUnicode;                N: UC + 'FPDFText_GetUnicode' + AT8;                Quirk: False),
    (P: @@FPDFText_GetCharBox;                N: UC + 'FPDFText_GetCharBox' + AT24;               Quirk: False),
    (P: @@FPDFText_GetCharIndexAtPos;         N: UC + 'FPDFText_GetCharIndexAtPos' + AT36;        Quirk: False),
    (P: @@FPDFText_GetText;                   N: UC + 'FPDFText_GetText' + AT16;                  Quirk: False),
    (P: @@FPDFText_CountRects;                N: UC + 'FPDFText_CountRects' + AT12;               Quirk: False),
    (P: @@FPDFText_GetRect;                   N: UC + 'FPDFText_GetRect' + AT24;                  Quirk: False),
    (P: @@FPDFText_GetBoundedText;            N: UC + 'FPDFText_GetBoundedText' + AT44;           Quirk: False),
    (P: @@FPDFText_FindStart;                 N: UC + 'FPDFText_FindStart' + AT16;                Quirk: False),
    (P: @@FPDFText_FindNext;                  N: UC + 'FPDFText_FindNext' + AT4;                  Quirk: False),
    (P: @@FPDFText_FindPrev;                  N: UC + 'FPDFText_FindPrev' + AT4;                  Quirk: False),
    (P: @@FPDFText_GetSchResultIndex;         N: UC + 'FPDFText_GetSchResultIndex' + AT4;         Quirk: False),
    (P: @@FPDFText_GetSchCount;               N: UC + 'FPDFText_GetSchCount' + AT4;               Quirk: False),
    (P: @@FPDFText_FindClose;                 N: UC + 'FPDFText_FindClose' + AT4;                 Quirk: False),
    (P: @@FPDFLink_LoadWebLinks;              N: UC + 'FPDFLink_LoadWebLinks' + AT4;              Quirk: False),
    (P: @@FPDFLink_CountWebLinks;             N: UC + 'FPDFLink_CountWebLinks' + AT4;             Quirk: False),
    (P: @@FPDFLink_GetURL;                    N: UC + 'FPDFLink_GetURL' + AT16;                   Quirk: False),
    (P: @@FPDFLink_CountRects;                N: UC + 'FPDFLink_CountRects' + AT8;                Quirk: False),
    (P: @@FPDFLink_GetRect;                   N: UC + 'FPDFLink_GetRect' + AT28;                  Quirk: False),
    (P: @@FPDFLink_CloseWebLinks;             N: UC + 'FPDFLink_CloseWebLinks' + AT4;             Quirk: False),
    (P: @@FPDFText_GetCharIndexFromTextIndex; N: UC + 'FPDFText_GetCharIndexFromTextIndex' + AT8; Quirk: False),
    (P: @@FPDF_RenderPageBitmap_Start;        N: UC + 'FPDF_RenderPageBitmap_Start' + AT36;       Quirk: False),
    (P: @@FPDF_RenderPage_Continue;           N: UC + 'FPDF_RenderPage_Continue' + AT8;           Quirk: False),
    (P: @@FPDF_RenderPage_Close;              N: UC + 'FPDF_RenderPage_Close' + AT4;              Quirk: False),
    (P: @@FPDFBookmark_GetFirstChild;         N: UC + 'FPDFBookmark_GetFirstChild' + AT8;         Quirk: False),
    (P: @@FPDFBookmark_GetNextSibling;        N: UC + 'FPDFBookmark_GetNextSibling' + AT8;        Quirk: False),
    (P: @@FPDFBookmark_GetTitle;              N: UC + 'FPDFBookmark_GetTitle' + AT12;             Quirk: False),
    (P: @@FPDFBookmark_Find;                  N: UC + 'FPDFBookmark_Find' + AT8;                  Quirk: False),
    (P: @@FPDFBookmark_GetDest;               N: UC + 'FPDFBookmark_GetDest' + AT8;               Quirk: False),
    (P: @@FPDFBookmark_GetAction;             N: UC + 'FPDFBookmark_GetAction' + AT4;             Quirk: False),
    (P: @@FPDFAction_GetDest;                 N: UC + 'FPDFAction_GetDest' + AT8;                 Quirk: False),
    (P: @@FPDFAction_GetURIPath;              N: UC + 'FPDFAction_GetURIPath' + AT16;             Quirk: False),
    (P: @@FPDFDest_GetPageIndex;              N: UC + 'FPDFDest_GetPageIndex' + AT8;              Quirk: False),
    (P: @@FPDFLink_GetLinkAtPoint;            N: UC + 'FPDFLink_GetLinkAtPoint' + AT20;           Quirk: False),
    (P: @@FPDFLink_GetDest;                   N: UC + 'FPDFLink_GetDest' + AT8;                   Quirk: False),
    (P: @@FPDFLink_GetAction;                 N: UC + 'FPDFLink_GetAction' + AT4;                 Quirk: False),
    (P: @@FPDFLink_Enumerate;                 N: UC + 'FPDFLink_Enumerate' + AT12;                Quirk: False),
    (P: @@FPDFLink_GetAnnotRect;              N: UC + 'FPDFLink_GetAnnotRect' + AT8;              Quirk: False),
    (P: @@FPDFLink_CountQuadPoints;           N: UC + 'FPDFLink_CountQuadPoints' + AT4;           Quirk: False),
    (P: @@FPDFLink_GetQuadPoints;             N: UC + 'FPDFLink_GetQuadPoints' + AT12;            Quirk: False),
    (P: @@FPDF_GetMetaText;                   N: UC + 'FPDF_GetMetaText' + AT16;                  Quirk: False),
    (P: @@FPDF_AddInstalledFont;              N: UC + 'FPDF_AddInstalledFont' + AT12;             Quirk: False),
    (P: @@FPDF_SetSystemFontInfo;             N: UC + 'FPDF_SetSystemFontInfo' + AT4;             Quirk: False),
    (P: @@FPDF_GetDefaultSystemFontInfo;      N: UC + 'FPDF_GetDefaultSystemFontInfo' + AT0;      Quirk: False),
    (P: @@FSDK_SetUnSpObjProcessHandler;      N: UC + 'FSDK_SetUnSpObjProcessHandler' + AT4;      Quirk: False),

    (P: @@FPDFDoc_GetPageMode;                N: UC + 'FPDFDoc_GetPageMode' + AT4;                Quirk: True),
    (P: @@FPDFDoc_GetPageMode;                N: 'FPDFDoc_GetPageMode';                           Quirk: False), // no UC, no ATx (older pdfium.dll versions)

    (P: @@FPDFAvail_Create;                   N: UC + 'FPDFAvail_Create' + AT8;                   Quirk: False),
    (P: @@FPDFAvail_Destroy;                  N: UC + 'FPDFAvail_Destroy' + AT4;                  Quirk: False),
    (P: @@FPDFAvail_IsDocAvail;               N: UC + 'FPDFAvail_IsDocAvail' + AT8;               Quirk: False),
    (P: @@FPDFAvail_GetDocument;              N: UC + 'FPDFAvail_GetDocument' + AT8;              Quirk: False),
    (P: @@FPDFAvail_GetFirstPageNum;          N: UC + 'FPDFAvail_GetFirstPageNum' + AT4;          Quirk: False),
    (P: @@FPDFAvail_IsPageAvail;              N: UC + 'FPDFAvail_IsPageAvail' + AT12;             Quirk: False),
    (P: @@FPDFAvail_IsFormAvail;              N: UC + 'FPDFAvail_IsFormAvail' + AT8;              Quirk: False),
    (P: @@FPDFAvail_IsLinearized;             N: UC + 'FPDFAvail_IsLinearized' + AT4;             Quirk: False),
    (P: @@FPDFDOC_InitFormFillEnvironment;    N: UC + 'FPDFDOC_InitFormFillEnvironment' + AT8;    Quirk: False),
    (P: @@FPDFDOC_ExitFormFillEnvironment;    N: UC + 'FPDFDOC_ExitFormFillEnvironment' + AT4;    Quirk: False),
    (P: @@FORM_OnAfterLoadPage;               N: UC + 'FORM_OnAfterLoadPage' + AT8;               Quirk: False),
    (P: @@FORM_OnBeforeClosePage;             N: UC + 'FORM_OnBeforeClosePage' + AT8;             Quirk: False),
    (P: @@FORM_DoDocumentJSAction;            N: UC + 'FORM_DoDocumentJSAction' + AT4;            Quirk: False),
    (P: @@FORM_DoDocumentOpenAction;          N: UC + 'FORM_DoDocumentOpenAction' + AT4;          Quirk: False),
    (P: @@FORM_DoDocumentAAction;             N: UC + 'FORM_DoDocumentAAction' + AT8;             Quirk: False),
    (P: @@FORM_DoPageAAction;                 N: UC + 'FORM_DoPageAAction' + AT12;                Quirk: False),
    (P: @@FORM_OnMouseMove;                   N: UC + 'FORM_OnMouseMove' + AT28;                  Quirk: False),
    (P: @@FORM_OnLButtonDown;                 N: UC + 'FORM_OnLButtonDown' + AT28;                Quirk: False),
    (P: @@FORM_OnLButtonUp;                   N: UC + 'FORM_OnLButtonUp' + AT28;                  Quirk: False),
    (P: @@FORM_OnKeyDown;                     N: UC + 'FORM_OnKeyDown' + AT16;                    Quirk: False),
    (P: @@FORM_OnKeyUp;                       N: UC + 'FORM_OnKeyUp' + AT16;                      Quirk: False),
    (P: @@FORM_OnChar;                        N: UC + 'FORM_OnChar' + AT16;                       Quirk: False),
    (P: @@FORM_ForceToKillFocus;              N: UC + 'FORM_ForceToKillFocus' + AT4;              Quirk: False),
    (P: @@FPDPage_HasFormFieldAtPoint;        N: UC + 'FPDPage_HasFormFieldAtPoint' + AT24;       Quirk: False),
    (P: @@FPDF_SetFormFieldHighlightColor;    N: UC + 'FPDF_SetFormFieldHighlightColor' + AT12;   Quirk: False),
    (P: @@FPDF_SetFormFieldHighlightAlpha;    N: UC + 'FPDF_SetFormFieldHighlightAlpha' + AT8;    Quirk: False),
    (P: @@FPDF_RemoveFormFieldHighlight;      N: UC + 'FPDF_RemoveFormFieldHighlight' + AT4;      Quirk: False),
    (P: @@FPDF_FFLDraw;                       N: UC + 'FPDF_FFLDraw' + AT36;                      Quirk: False)
  );
